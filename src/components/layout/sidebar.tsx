    ...
    >
      ...
      <div className="h-16 flex items-center px-4 gap-3 border-b border-slate-100 dark:border-[#141e33]/60 shrink-0">
        <Link href="/" className="flex items-center gap-2.5">
          <div className="relative w-9 h-9 rounded-xl overflow-hidden bg-[#0a1628] border border-cyan-500/30 flex items-center justify-center shadow-[0_0_15px_rgba(6,182,212,0.2)] shrink-0">
            <img
              src="/images/logo.jpg"
              alt="STEAMIFY Logo"
